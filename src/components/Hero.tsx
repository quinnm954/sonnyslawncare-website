...
const Hero = () => {
  return (
    <section className="relative pt-20 pb-12 md:pt-32 md:pb-24 bg-gradient-to-b from-background to-secondary/20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <p className="inline-block px-3 py-1 mb-3 text-[11px] md:text-xs font-semibold tracking-wider uppercase rounded-full bg-primary/10 text-primary">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button asChild size="lg" variant="secondary" className="gap-2 w-full sm:w-auto min-h-12">
